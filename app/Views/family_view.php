    ...
    <section class="content">
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          ...
          <div class="box-tools">              
              <button type="button" class="btn-sm  btn btn-success modalButtonFamily" data-src="<?php echo '0';?>" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Add <?php echo $title;?></button>              
            </div>         
        </div>
...
<!-- /.content-wrapper -->
<!-- Modal Crud Start-->
<div class="modal fade" id="nameModal_Family" role="dialog">
