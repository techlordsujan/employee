  ...
  $(document).ready(function() {  
    ...
    setTimeout(function() {
      ...
      $('.table-date-range').css('right',add_width+'px');
        ...
        $('.dataTables_info').before('<button data-base-url="<?php echo base_url().'index.php/'.'user/delete/'; ?>" rel="delSelTable" class="btn btn-default btn-sm delSelected pull-left btn-blk-del"> <i class="fa fa-trash"></i> </button><br><br>');  
    }, 300);
