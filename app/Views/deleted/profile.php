...
<!-- Main content -->
  ...
  <?php } ?>
    ...
    <div class="box box-success pad-profile">
      ...
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'/index.php/user/add_edit' ?>" class="form-label-left">
        <div class="box-body box-profile">
          <div class="col-md-3">
            ...
            <br>
            <div class="fileUpload btn btn-success wdt-bg" style="display:none">
          ...
          <div class="col-md-8">
            <h3>Personal Information:</h3>
					...
					<div class="form-group has-feedback">
		              ...
		              <select name="status" id="status" class="form-control" disabled="dispabled">
					...
					<div class="form-group has-feedback clear-both">
		              ...
		              <input type="text" id="name" name="name" value="<?php echo (isset($user_data[0]->name)?$user_data[0]->name:'');?>" required="required" class="form-control" placeholder="Name" readonly>
					...
					<div class="form-group has-feedback clear-both">
		              ...
		              <input type="text" id="email" name="email" value="<?php echo (isset($user_data[0]->email)?$user_data[0]->email:'');?>" required="required" class="form-control" placeholder="Email" readonly>
		              <span class="glyphicon glyphicon-user form-control-feedback"></span>
		            </div>
