...
<head>
  ...
  <title><?php echo $title."::HBL-KYE";?></title>
          ...
          <header class="main-header">
            <a href="<?php echo base_url(); ?>" class="logo">
             <?php $logo =  "logo.png"; ?>
              ...
              <span class="logo-mini"><img src="<?php echo base_url().'assets/images/_user.png'; ?>" id="logo"></span>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                               <?php 
                            $profile_pic =  $session_data['avatar'];
                              if(!file_exists(WRITEPATH . 'uploads/avatar/' . $profile_pic))
                              {
                                 $profile_pic = 'avatar.jpg';
                              }?>
                              <img src="<?php echo base_url().'resource/avatar/'.$profile_pic;?>"  class="user-image" alt="User Image">
                            <span class="hidden-xs"><?php echo $session_data['staff_name'];?></span>
                          </a>
                          <ul class="dropdown-menu" role="menu" style="width: 164px;">
                              <!--li><a href="<?php echo base_url('user/profile');?>"><i class="fa fa-user mr10"></i>Change Password</a></li-->
                              <li class="divider"></li>
